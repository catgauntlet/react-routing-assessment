...
describe("Home screen - Happy flows", () => {
    ...
    test.skip('When I load the homepage component when I am logged in, I expect to see the welcome text', () => {
    
    });

    test.skip('When I load the homepage component when I am logged in, I expect the dashboard menu link to be clickable and to redirect me', () => {
